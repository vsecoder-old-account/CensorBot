...
async def info(message: types.Message):
    await bot.send_chat_action(message.chat.id, 'typing')
    time.sleep(1)
    await bot.send_message(message.chat.id, 'Ну раз спросил, то в мои возможности входят несколько функций, я обрабатываю все сообщения пользователей, и если это сообщение содержит мат, то я его удаляю, но на всякий случай я присылайю сообщение помеченное вашим именем, но вместо матов три точки, из этого я веду статистику, и приветствую новых пользователей!')
